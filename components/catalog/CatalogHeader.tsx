      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="relative flex items-center">
          ...
          <Input
            ...
            className="pl-10 pr-36 h-12 bg-gray-50 border-gray-200 focus:border-purple-500 focus:ring-purple-500"
          />
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
            {/* Индикатор загрузки */}
            {isSearching && (
              <Loader2 className="h-5 w-5 text-purple-600 animate-spin mr-1" />
            )}
        ...
        {activePanel === 'photo' && (
          <div className="absolute left-0 right-0 top-full mt-2 bg-white rounded-xl shadow-xl border border-gray-200 p-6 z-50">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 bg-purple-600 rounded-lg flex items-center justify-center flex-shrink-0">
                <Camera className="w-5 h-5 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-gray-900">Поиск по фото</h3>
                <p className="text-sm text-gray-500">Загрузите фото товара</p>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2">
              <button onClick={closePanel} className="px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-lg">
                Отмена
              </button>
              <button
        ...
        {activePanel === 'link' && (
          <div className="absolute left-0 right-0 top-full mt-2 bg-white rounded-xl shadow-xl border border-gray-200 p-6 z-50">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Поиск по ссылке</h3>
                <p className="text-sm text-gray-500">Вставьте ссылку на товар</p>
              </div>
            </div>
            <input
              type="url"
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm mb-4"
            />
            <div className="flex justify-end gap-2">
              <button onClick={closePanel} className="px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-lg">
                Отмена
        ...
        {activePanel === 'supplier' && (
          <div className="absolute left-0 right-0 top-full mt-2 bg-white rounded-xl shadow-xl border border-gray-200 p-6 z-50">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Найти поставщика</h3>
                <p className="text-sm text-gray-500">Опишите нужный товар</p>
              </div>
            </div>
            <textarea
              placeholder="Опишите товар..."
              rows={3}
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm mb-4 resize-none"
            />
            <div className="flex justify-end gap-2">
              <button onClick={closePanel} className="px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-lg">
                Отмена
