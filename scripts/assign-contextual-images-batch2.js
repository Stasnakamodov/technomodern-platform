/**
 * 🎨 Скрипт для назначения уникальных изображений - ВТОРАЯ ПАРТИЯ (51-100)
 *
 * Использование:
 * 1. Подождите 1 час после первого запуска (rate limit)
 * 2. Запустите: node scripts/assign-contextual-images-batch2.js
 */
...
const PRODUCTS_OFFSET = 50; // Пропускаем первые 50
...
async function assignContextualImages() {
  console.log('\n🎨 ========================================');
  console.log('  Назначение изображений - ПАРТИЯ 2');
  console.log('  Товары: 51-100');
  console.log('========================================\n');
  ...
  try {
    ...
    // 2. Загружаем товары 51-100 (используем offset)
...
console.log('\n🚀 Запуск скрипта для второй партии товаров...\n');
